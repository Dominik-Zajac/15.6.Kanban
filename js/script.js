$(function() {
    ...
    function Board(title) {
        ...
        function createBoard() {
            ...
            var $boardTitle = $('<h1>').addClass('board-title').text(self.title);
            var $boardDelete = $('<button>').addClass('btn-delete-board').text('Delete board');
            var $boardColumnAdd = $('<button>').addClass('create-column').text('Add a column');
